  ...
  if (answerelement.matches("li")) {
    ...
    if (answerelement.textContent == questions[currentQuestionindex].answer) {
      ...
      createDiv.textContent =
        "Congra!!! the answer is: " + questions[currentQuestionindex].answer;
      console.log("plus 1");
      //  the user answer it wrong point will go down
    } else {
      timeleft = timeleft - penalty;
      createDiv.textContent =
        "Opps! the correct answer is: " +
...
function GameOver() {
  ...
  questionContainerElement.appendChild(createh1);

  var createp = document.createElement("p");
  createp.setAttribute("id", "createp");

  questionContainerElement.appendChild(createp);
